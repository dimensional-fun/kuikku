...
public class SHA512 : Memoable, LongDigest {
    public companion object {
        public const val DIGEST_SIZE: Int = 64
    }

    override val algorithmName: String get() = "SHA512"
    ...
    public constructor(other: SHA512) : super() {
        reset(other)
    }
    ...
    override fun copy(): SHA512 = SHA512(this)

    override fun reset(other: Memoable): SHA512 {
        require (other is SHA512)
        copyIn(other)
        return this
    }
}
